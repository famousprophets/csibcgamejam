...
func _ready():
	...
	$Panel/RichTextLabel.text = "As you travel through the road. You spot a swordsman with a black cloak, a metal arm and a huge 200 pound sword (pick your dialouge)" #write whats happening in the scenario here.
	$Panel/HBoxContainer/Button.text = "How much for the sword?" #input text for the choices
	$Panel/HBoxContainer/Button2.text = "[Ignore the swordsman]"
...
func _on_button_pressed(): 
	choicemade()
	$Panel/RichTextLabel.text = "The Swordsman: Not for sale, and i doubt someone like you can carry it" #write the outcome of the scenario here



func _on_button_2_pressed():
	choicemade()
	$Panel/RichTextLabel.text = "Okay dude i dont know how someone can just ignore something like that but fine, you do you"
